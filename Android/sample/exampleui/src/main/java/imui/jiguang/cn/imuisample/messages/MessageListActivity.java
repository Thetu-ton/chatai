...
public class MessageListActivity extends Activity implements View.OnTouchListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatView.setMenuClickListener(new OnMenuClickListener() {
            ...
            public boolean onSendTextMessage(CharSequence input) {
                ...
                // 3. Send to Mem0 for long-term memory extraction (async, fire-and-forget)
                MemoryManager.getInstance().memorize(text);

                // 4. Create typing indicator for AI response
                ...
                MemoryManager.getInstance().buildSystemPromptAsync(prompt -> {
                    ...
                    AiInteract.getInstance().sendTextMessage(text, new AiCallback() {
                        ...
                        public void onResponse(AiMessage aiMessage) {
                            ...
                            mAdapter.updateMessage(message.getMsgId(), message);
                        }
                        ...
                        public void onError(int code, String errorMsg) {
                            ...
                            Toast.makeText(MessageListActivity.this,
                                "AI Error (" + code + "): " + errorMsg, Toast.LENGTH_SHORT).show();
                        }
    ...
    private void initModules() {
        ...
        MemoryConfig memoryConfig = new MemoryConfig.Builder()
            ...
            .build();
        MemoryManager.init(getApplicationContext(), memoryConfig);
        ...
        AiConfig aiConfig = new AiConfig.Builder(
            ...
            .aiUserAvatar("R.drawable.deadpool")
            .build();
